            ...
            <div className="userPass">
                <form action='/login' method='POST' className="userForm">
                    ...
                    <div className="userFormsignUpButton ">
                        <input type='submit' value="Login" className="signUpButton opacity0_8"></input>
                    </div>
                </form>
                <form action='/signup' method='POST' className="userFormSignUp">
                    <input type='submit' value="Signup" className="loginSignUpButton opacity0_8"></input>
                </form>
            </div>
        </div>
    );
